"""
    ...
    SOURCE CODE MODIFIED FEBRUARY 2017 FOR USE IN THIS PROJECT
...
#        print 'txtinp: width={} rtX={} font={} lineChars={} lineH={}'.format(self.w,rtX,fsize, self.lineChars,self.lineH)
        ...
        self.cursorlayer = pygame.Surface((2,30)) # thin vertical line
